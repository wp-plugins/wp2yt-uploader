...
require_once YT4WP_PATH.'inc/tests/BaseTest.php';
require_once YT4WP_PATH.'inc/tests/adsense/AdSenseTest.php';
require_once YT4WP_PATH.'inc/tests/general/GeneralTests.php';
require_once YT4WP_PATH.'inc/tests/tasks/AllTasksTests.php';
require_once YT4WP_PATH.'inc/tests/pagespeed/AllPageSpeedTests.php';
require_once YT4WP_PATH.'inc/tests/urlshortener/AllUrlShortenerTests.php';
require_once YT4WP_PATH.'inc/tests/plus/PlusTest.php';
require_once YT4WP_PATH.'inc/tests/youtube/YouTubeTest.php';
