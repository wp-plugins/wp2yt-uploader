...
This plugin will install a set of SVG webfont icons for use on your site. Users can select which icon they want to
use and copy the provided code for use on any page. 
