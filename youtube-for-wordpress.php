...
if(!defined('YT4WP_VERSION_CURRENT'))				define('YT4WP_VERSION_CURRENT',	'2.0');
...
if(!defined('YT4WP_PATH'))							define('YT4WP_PATH',				ABSPATH.'wp-content/plugins/youtube-for-wordpress/');
...
require_once YT4WP_PATH.'lib/lib.func.php';
