...
<div class="wrap ytplus-page-about">
	...
	<h2 class="nav-tab-wrapper" style="margin-top:0;">
		<a href="?page=youtube-for-wordpress-settings&tab=yt-plus-add_ons" class="nav-tab <?php echo $active_tab == 'yt-plus-add_ons' ? 'nav-tab-active' : ''; ?>"><?php _e('Add Ons','youtube-for-wordpress-translation'); ?></a>
		<a href="?page=youtube-for-wordpress-settings&tab=yt-plus-themes" disabled="disabled" onclick="return false;" class="yt-plus_themes_tab nav-tab <?php echo $active_tab == 'yt-plus-themes' ? 'nav-tab-active' : ''; ?>" ><?php _e('Themes (coming soon)','youtube-for-wordpress-translation'); ?></a>
	</h2>
	...
	/*
		...
		$url = 'http://www.youtubeforwordpress.com/wp-json/posts/1';
